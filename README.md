...
curl --fail --location \
  -o ~/rpmbuild/SOURCES/claude-desktop_2.2553.1_amd64.deb \
  'https://downloads.claude.ai/claude-desktop/apt/stable/pool/main/c/claude-desktop/claude-desktop_2.2553.1_amd64.deb'
